...
// Buildings
  ...
  new Building({ id: 'mill',
    ...
    prereqs: { wheel: true },
    get require() {
      return { wood: 100 * (this.owned + 1) * Math.pow(1.05, this.owned),
...
// xxx This should probably change.
  ...
  new Building({ id: 'fieldsAltar',
    ...
    set require(value) { return this.require }, // Only here for JSLint.
    effectText: '+1 Devotion' }),
  new Building({ id: 'underworldAltar',
    name: 'Build Altar',
...
// Pantheon Upgrades
  ...
  new Upgrade({ id: 'riddle',
    name: 'Riddle of Steel',
    subType: 'pantheon',
    prereqs: { deity: 'battle', devotion: 10 },
    require: { piety: 1000 },
    effectText: 'improve soldiers' }),
  new Upgrade({ id: 'throne',
