/* global Resource Building adjustMorale digGraves Upgrade
    ...
    getCurDeityDomain indexArrayByAttr CivObj */
function civDataTable() { // eslint-disable-line no-unused-vars
  const civData = [
    ...
    new Upgrade({
      ...
      extraText: `<br>
        <button class='btn btn-secondary btn-sm' id='ceaseWalk'
          onmousedown='walk(false)' disabled='disabled'>Cease Walking</button>`,
    }),
    new Upgrade({
      id: 'raiseDead',
      name: 'Raise Dead',
      ...
      extraText: `
        <button onmousedown='raiseDead(100)' id='raiseDead100'
          class='btn btn-secondary btn-sm x100' disabled='disabled'>+100</button>
        <button onmousedown='raiseDead(Infinity)' id='raiseDeadMax'
          class='btn btn-secondary btn-sm xInfinity' disabled='disabled'>+&infin;</button>`,
    }),
    new Upgrade({
      id: 'summonShade',
      name: 'Summon Shades',
